package 
{
    ...
    public class AvatarEditor extends Sprite
    {
        ...
        private function editPhoto() : void
        {
            ...
            this.smallEditWin.edit(this.editData, 110, 66);
            this.editState.addChild(this.bigEditWin);
            this.bigEditWin.edit(this.editData, 240, 144);
        ...
        private function initUI() : void
        {
            ...
            this.largeThumb = new PhotoThumb(240, 144, "你的大头像(将显示在个人主页)");
            this.smallThumb = new PhotoThumb(110, 66, "你的小头像");
            this.previewState.addChild(this.largeThumb);
            this.previewState.addChild(this.smallThumb);
            this.smallThumbButton = new ThumbButton(110, 66, "小头像预览");
            this.smallThumbButton.drawData(new BitmapData(110, 66, false, 13421772));
            this.bigThumbButton = new ThumbButton(240, 144, "大头像预览");
            this.bigThumbButton.drawData(new BitmapData(240, 144, false, 13421772));
        ...
        private function createEditWin() : void
        {
            ...
            this.bigEditWin = new EditWindow(null, 280, 330, 240, 144);
