...
//上传后图片的绝对地址
//$pic_abs_path = 'http://sns.com/avatar/avatar_origin/'.$pic_id.'.jpg';
...
//写新上传照片的ID.
echo '<script type="text/javascript">window.parent.hideLoading();window.parent.buildAvatarEditor("'.$pic_id.'","./avatar_origin/logo.png","photo");</script>';
?>
</body>
</html>