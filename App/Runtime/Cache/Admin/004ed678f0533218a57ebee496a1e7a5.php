...
<head>
    ...
    <script type="text/javaScript" src="<?php echo __JS_PATH__?>/jquery-1.8.3.js"></script>
    <script language="JavaScript" src="<?php echo __JS_PATH__?>/admin_common.js"></script>
</head>
<body>
<div class="showMsg" style="text-align:center">
    ...
    <div class="bottom">
        ...
        <?php } elseif($jumpUrl) { ?>
        <a href="<?php echo $jumpUrl?>">点击这里</a>
        <script language="javascript">setTimeout("redirect('<?php echo $jumpUrl?>');",<?php echo $waitSecond;?>);</script>
        <?php }?>
