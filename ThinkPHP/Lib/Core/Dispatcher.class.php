...
//     			$file .= 'Apple/';
//     		}
            C('DEFAULT_MODULE','Index');
        }else if(preg_match("/mobile/",$agent) || strpos($agent,"NetFront") || strpos($agent,"iPhone") || strpos($agent,"MIDP-2.0") || strpos($agent,"Opera Mini") || strpos($agent,"UCWEB") || strpos($agent,"Android") || strpos($agent,"Windows CE") || strpos($agent,"SymbianOS")){
            //手机
