...
/*
 测试账号：注册序列号：0SDK-EAA-0130-NDSMK    密码：026591   特服号：529699 
 */
...
function getMO()
{
	...
	foreach($moResult as $mo)
	{
		...
		// 实例代码为直接输出
	 	...
	 	/**
	 	 * 由于服务端返回的编码是GBK,所以需要进行编码转换
	 	 */
	 	echo "短信内容:".iconv("GBK","UTF-8",$mo->getSmsContent());
...
function sendSMS()
{
	 ...
	 */
	$statusCode = $client->sendSMS(array('18610085949'),"test测试");
	echo "处理状态码:".$statusCode;
}
