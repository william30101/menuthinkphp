...
class Page {
     ...
     * @param unknown $val
     * author Tony 
     * added by Tony 2013/09/06
     */
    public function setNowPage($val){
    	$this->nowPage = $val;
    }
    /**
     +----------------------------------------------------------
	...
	public function getStyle($value){ 
    	if($value=='easy'){
    		$this->config = array('prev'=>'上一页','next'=>'下一页','theme'=>'<div class="btnGray26">%upPage%</div> <div class="pageNow"><a id="showPage" href="javascript:" class="text">第<font style="color:red;">%nowPage%</font>页</a></div> <div class="btnGray26">%downPage%</div>');
    	}
	}
    /**
     +----------------------------------------------------------
    ...
    public function show() {
        ...
        if($nowCoolPage == $this->coolPages){
            ...
            if(($totalPages-$nowPage)>4){ //剩余要大于4才可显示下5页 added by Tony
