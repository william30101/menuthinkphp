...
class Cache_file {
	...
	public function set($name, $data, $setting = '', $type = 'data', $module = MODULE_NAME) {
		$this->get_setting($setting);
	 ...
	 */
	public function get($name, $setting = '', $type = 'data', $module = MODULE_NAME) {
		$this->get_setting($setting);
		if(empty($type)) $type = 'data';
		if(empty($module)) $module = MODULE_NAME;
		$filepath = CACHE_PATH.'Caches_'.$module.'/Caches_'.$type.'/';
	 ...
	 * @return  bool
	 */
	public function delete($name, $setting = '', $type = 'data', $module = MODULE_NAME) {
		$this->get_setting($setting);
		if(empty($type)) $type = 'data';
		if(empty($module)) $module = MODULE_NAME;
		$filepath = CACHE_PATH.'Caches_'.$module.'/Caches_'.$type.'/';
	...
	public function cacheinfo($name, $setting = '', $type = 'data', $module = MODULE_NAME) {
		$this->get_setting($setting);
		if(empty($type)) $type = 'data';
		if(empty($module)) $module = MODULE_NAME;
		$filepath = CACHE_PATH.'Caches_'.$module.'/Caches_'.$type.'/';
